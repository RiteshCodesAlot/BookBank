...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="index.html">BOOK BANK</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a class="btn btn-primary" href="{{ route('account.donate') }}" type="submit">Donate a book</a>
			</div>
		</div>
	</nav>
</header>
<section class="section-0 lazy d-flex bg-image-style dark align-items-center " class="" data-bg="{{ asset('assets/images/lib.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Book Bank System</h1>
                <p>Click here for Registeration and Donate a Book</p>
